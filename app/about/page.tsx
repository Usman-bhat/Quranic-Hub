    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gradient-to-b from-blue-500 via-gray-400 to-orange-500">
        ...
        <p className="text-gray-700 text-center max-w-2xl">
          Welcome to QuranicHub, the online haven for seekers of
          Islamic wisdom and the profound teachings of the Quran.it is our
          ...
          tribute to the great philosopher-poet Allama Iqbal, We have curated a
        ...
        <p className="text-gray-700 text-center max-w-2xl mt-5 arabicFont">
          ...
          into its structure and meaning. Authored by Molana MahiudDeen Darwash, this
